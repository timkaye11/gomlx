...
// Generic POD types are registered via simplego_dispatcher.
// BFloat16/Float16 are registered here with specialized implementations that output float32.
var dotGeneralSmallMatMulDTypeMap = NewDTypeMap("DotGeneralSmallMatMul")

func init() {
	// BFloat16 and Float16 need float32 accumulation and output float32 buffer.
	// The caller handles conversion back to native dtype.
...
// Registered via simplego_dispatcher for Int8-64, Uint8-64, Float32, Float64.
